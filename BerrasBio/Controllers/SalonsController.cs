...
namespace BerrasBio.Controllers
{
    public class SalonsController : Controller
    {
        ...
        public SalonsController(BerrasTempoContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,MaxVisitors")] Salon salon)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,MaxVisitors")] Salon salon)
        {
            if (id != salon.Id)
            {
                return NotFound();
